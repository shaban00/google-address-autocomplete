...
class AddressAutocomplete {
  ...
  initAutocomplete = (field, type) => {
    ...
    const supportedCountries = this.getSupportedCountries(fieldInputs.country);
  ...
  parseStreetAddress = (addressComponents) => {
    ...
    const route = this.getAddressComponentLongName(addressComponents, "route");
  ...
  parseCity = (addressComponents, country) => {
    ...
    if ("GB" === country) {
      city = this.getAddressComponentLongName(addressComponents, "postal_town");
      if (city === "") {
